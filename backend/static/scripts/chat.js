(() => {
  ...
  (s.n = (t) => {
    ...
    (() => {
            ...
            : o &&
              (s instanceof ArrayBuffer ||
                ...
                "function" == typeof ArrayBuffer.isView
                  ...
                  : h && h.buffer instanceof ArrayBuffer))
            ? n
              ? i(s)
              : a(new Blob([s]), i)
            : i(e[t] + (s || ""));
      ...
      function j() {}
      const D = null != new q({ xdomain: !1 }).responseType;
      class I extends g {
        constructor(t, e) {
          super(),
            k(this, e),
      ...
      var bt = s(906),
        vt = s.n(bt);
      const _t = document.querySelector("#messages");
      mt.on(
        vt().CHAT_MESSAGE_RECEIVED,
